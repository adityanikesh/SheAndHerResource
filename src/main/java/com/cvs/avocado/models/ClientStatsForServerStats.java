...
public class ClientStatsForServerStats {
    ...
    private Timestamp close_timestamp;
	...
	public Timestamp getClose_timestamp() {
		return close_timestamp;
	}
	public void setClose_timestamp(Timestamp close_timestamp) {
